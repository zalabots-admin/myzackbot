                                      ...
                                      case 'date':
                                        return (
                                          <div  className='flex w-full'>
                                            {response.Value !== '' ? <><div className='w-[93%]'>{formatDate(response.Value)}</div><div title='Copy Response' className='w-[7%] text-[20px] text-gray-300 cursor-pointer hover:text-[#00556680]' onClick={() => handleCopy(formatDate(response.Value))}><i className={"fa-sharp fa-thin fa-clone "}></i></div></> : null}
                                          </div>
                                        )
                                      case 'file':
                                        return (
                                          <div  className='flex w-full'>
                                            ...
                                            <div title='Download File' className='w-[7%] text-[20px] text-gray-300 cursor-pointer hover:text-[#00556680]' onClick={() => handleDownload(response.Value, response.id)}><i className={"fa-sharp fa-thin fa-download "}></i></div>
                                            <a title='Open File in New Tab' className='w-[7%] cursor-pointer' href={import.meta.env.VITE_DOC_URL + response.id} target="_blank" rel="noopener noreferrer"><div className='text-[20px] text-gray-300 cursor-pointer hover:text-[#00556680]'><i className={"fa-sharp fa-thin fa-up-right-from-square "}></i></div></a>
                                          </div>
                                      )
                                      default:
                                        return (
                                          <div  className='flex w-full'>
                                             {response.Value !== '' ? <><div className='w-[93%]'>{response.Value}</div><div title='Copy Response' className='w-[7%] text-[20px] text-gray-300 cursor-pointer' onClick={() => handleCopy(response.Value)}><i className={"fa-sharp fa-thin fa-clone "}></i></div></> : null}
                                          </div>
                                        )
                                    }
                                  })()}
